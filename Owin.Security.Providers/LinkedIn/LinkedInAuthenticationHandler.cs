...
namespace Owin.Security.Providers.LinkedIn
{
    public class LinkedInAuthenticationHandler : AuthenticationHandler<LinkedInAuthenticationOptions>
    {
        ...
        private const string UserInfoEndpoint = "https://api.linkedin.com/v1/people/~:(id,last-modified-timestamp,summary,interests,positions,skills,certifications,educations,courses,projects)";
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:linkedin:full_profile", context.Profile, XmlSchemaString, Options.AuthenticationType));
                }
